...
import { usePatchSubmittedProfileMutation } from './usePatchSubmittedProfileMutation';
import { PatchSubmittedProfileRequest, ProfileResponse } from '@profile/types/profile';
...
export const useEditProfileForm = ({ profile, toggleModal }: Props) => {
    ...
    const { patchProfile } = usePatchSubmittedProfileMutation();
    ...
    const submitForm = () => {
        const formData: PatchSubmittedProfileRequest = {
            job,
